...
function calendar_civicrm_install() {
  return _calendar_civix_civicrm_install();
}
...
function calendar_civicrm_uninstall() {
  return _calendar_civix_civicrm_uninstall();
}
...
function calendar_civicrm_enable() {
  return _calendar_civix_civicrm_enable();
}
...
function calendar_civicrm_disable() {
  return _calendar_civix_civicrm_disable();
}
...
function calendar_civicrm_managed(&$entities) {
  return _calendar_civix_civicrm_managed($entities);
}
